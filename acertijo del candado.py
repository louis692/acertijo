...
while True:
    try:
        numero_1 = int(input("Por favor, ingresa un número del 0 al 9: "))
        if 0 <= numero_1 <= 9:    
            print("Has ingresado el número válido:", numero_1)
            if numero_1 == 8:
                print("el primer numero es correcto")
            elif numero_1 == 1:
                print("el numero pertenece a la combinacion")
            elif numero_1 == 3:    
                print("el numero pertenece a la combinacion")
            else:
...
while True:
    try:
        numero_2 = int(input("Por favor, ingresa un número del 0 al 9: "))
        if 0 <= numero_2 <= 9:
...
while True:
    try:
        numero_3 = int(input("Por favor, ingresa un número del 0 al 9: "))
        if 0 <= numero_3 <= 9:
